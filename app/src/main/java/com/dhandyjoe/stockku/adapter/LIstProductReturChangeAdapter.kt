...
import com.dhandyjoe.stockku.databinding.ItemListProductChangeBinding
...
class LIstProductReturChangeAdapter(
...
): RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    class MyViewHolder(val binding: ItemListProductChangeBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MyViewHolder(ItemListProductChangeBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
